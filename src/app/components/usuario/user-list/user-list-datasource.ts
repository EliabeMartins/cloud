...
const EXAMPLE_DATA: UserListItem[] = [
  {id: 1, name: 'ELAIBE MARTINS', email:'eliabe@servicetrix.com', password: '12345'},
  {id: 2, name: 'LUCAS', email:'lucas@servicetrix.com', password: '12345'},
  {id: 3, name: 'MARCO', email:'marco@servicetrix.com', password: '12345'},
  {id: 4, name: 'PEDRO', email:'pedro@servicetrix.com', password: '12345'},
  {id: 5, name: 'BORUTO', email:'boruto@servicetrix.com', password: '12345'},
